...
Default workflows and community files for repos under [@axiomantic](https://github.com/axiomantic).
...
`workflow-templates/pr-agent.yml` makes the same workflow available in the GitHub "New workflow" UI for any new repo under `@axiomantic`.
